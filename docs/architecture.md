...
| **2** | Pełny regulamin/prywatność, rebranding UI gry, podium końca meczu | Rebrand UI gry ✅; reszta zaplanowana |
...
│   │   └── css/playclub.css
│   ├── css/
│   │   ├── playclub-tokens.css   # tokeny designu PlayClub
│   │   ├── playclub-game.css      # skin UI gry
│   │   ├── style.css
│   │   └── mobile.css
│   ├── js/
