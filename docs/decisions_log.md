...
## 2026-07 — Rebrand UI gry pod PlayClub

**Decyzja:** Gra Żużel (`index.html`, `local.html`) dostaje ten sam visual language co lobby: tokeny CSS, Poppins/Inter, Play Green, header PLAY▶CLUB + tytuł „Żużel”.

**Kontekst:** Po deployu playclub.pl lobby było w nowym brandzie, gra w starym GitHub-dark stylu.

**Konsekwencje:**
- `public/css/playclub-tokens.css` — wspólne zmienne designu
- `public/css/playclub-game.css` — skin UI (ładowany po `style.css`)
- Logo PlayClub linkuje do lobby (`/` na playclub.pl, `https://playclub.pl/` na zuzel.hpkgrupa.pl)
- Canvas i tor bez zmian
